    ...
    def createHeadersTables(self):
        ...
        self._dbWriteInterface.ExecCommit(
            '''INSERT INTO Headers (Name, Label, Width, DataType, Comment) VALUES
                ('id', 'ID расширения', 180, 'string', 'Уникальный идентификатор расширения'),
                ('name', 'Название', 195, 'string', 'Имя расширения'),
                ('version', 'Версия', 155, 'string', 'Версия установленного расширения'),
                ('description', 'Описание', 200, 'string', 'Описание функционала расширения'),
                ('type', 'Тип', 165, 'string', 'Тип расширения'),
                ('active', 'Активно', 150, 'int', '1 — активно, 0 — отключено'),
                ('user_disabled', 'Отключено пользователем', 185, 'int', '1 — пользователь отключил, 0 — нет'),
                ('install_date', 'Дата установки', 175, 'int', 'Время установки расширения'),
                ('update_date', 'Дата обновления', 175, 'int', 'Время последнего обновления'),
                ('path', 'Путь', -1, 'string', 'Путь к файлам расширения'),
                ('source_url', 'Источник', -1, 'string', 'URL источника расширения'),
                ('permissions', 'Разрешения', 195, 'string', 'Список разрешений расширения'),
                ('location', 'Расположение', 170, 'string', 'Где установлено расширение'),
