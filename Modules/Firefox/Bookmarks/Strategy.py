    ...
    def createHeadersTables(self):
        ...
        self._dbWriteInterface.ExecCommit(
            '''INSERT INTO Headers (Name, Label, Width, DataType, Comment) VALUES
                ...
                ('title', 'Название', 200, 'string', 'Название закладки'),
                ('date_added', 'Дата добавления', -150, 'string', 'Когда закладка была создана'),
                ('last_modified', 'Дата изменения', 150, 'string', 'Когда закладка была изменена'),
